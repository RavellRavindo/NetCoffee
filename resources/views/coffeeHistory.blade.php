...
<body>
    ...
    <!--Contents-->
    <h1 class="judul display-5 text-center text-muted my-4 my-5">Coffee History</h1>
    <div class="container pt-4">
        <div class="row">
            <div class="row">
                ...
                <div class="col-lg">
                    <h3 class="mb-4">Arabica Wamena</h3>
                    <p>
                        ...
                        are not technically beans, they are referred to as such because of their resemblance to true beans. The fruits; cherries or berries, most commonly contain two stones with their flat sides together. A small percentage of cherries
                        contain a single seed, instead of the usual two. This is called a "peaberry". The peaberry occurs only between 10% and 15% of the time, and it is a fairly common belief that they have more flavour than normal coffee beans.Like
                        Brazil nuts and white rice, coffee beans consist mostly of endosperm.
                    </p>
                </div>
                <div class="col-lg">
                    <h3 class="mb-4">Gayo Sumatera</h3>
                    <p>
                        ...
                        coffee grounds are placed into a paper or metal filter inside a funnel, which is set over a glass or ceramic coffee pot, a cooking pot in the kettle family. Cold water is poured into a separate chamber, which is then boiled and
                        directed into the funnel. This is also called automatic drip-brew.
                    </p>
                </div>
            </div>
        </div>
