...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #876445">
        <div class="container">
            <a class="navbar-brand" href="/">NetCoffee</a>
    ...
    <h1 class=" judul display-5 text-center text-muted my-4 my-5">Admin Page</h1>
        ...
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="true" href="/adminUpdate">Update</a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="/adminDelete">Delete</a>
            </li>
          </ul>
        </div>
        <div class="card-body">
          <h5 class="card-title text-center">Update Content</h5>
          <div class="container mt-5 mb-5">
            <div class="row justify-content-center">
                <div class="card shadow" style="width: 80rem;">
                    ...
                    <form class="row g-4" action="/adminUpdate" method="POST">
                    @csrf
                          <div class="col-md-6">
