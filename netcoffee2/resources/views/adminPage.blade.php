    ...
    <h1 class=" judul display-5 text-center text-muted my-4 my-5">Admin Page</h1>
        ...
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs">
            <li class="nav-item">
              <a class="nav-link active" aria-current="true" href="/adminPage">Input</a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="/adminUpdate">Update</a>
            </li>
            <li class="nav-item">
        ...
        <div class="card-body">
          <h5 class="card-title text-center">Input Content</h5>
